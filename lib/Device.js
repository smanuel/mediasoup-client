...
function isIOSCordova(browser, majorVersion) {
    ...
    if (platform.type === 'mobile' && platform.vendor === 'Apple') {
        ...
        const isCordova = (browser.getOSName() === 'macOS') && window.cordova;
        return isCordova;
    }
}
function detectDevice() {
    ...
    // Browser.
        ...
        else if ((browser.satisfies({ safari: '>=12.0' }) || isIOSCordova(browser, 12)) &&
